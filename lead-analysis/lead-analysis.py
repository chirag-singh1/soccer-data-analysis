...
if __name__ == '__main__':
    ...
    parser.add_argument('-A','--analysis',required=False,nargs=1, default='halftime-lead', choices=['halftime-lead','halftime-percent-adjusted'])
    ...
    if args.analysis[0] == 'halftime-lead':
        ...
        nextgoal.run_analysis(competitions)