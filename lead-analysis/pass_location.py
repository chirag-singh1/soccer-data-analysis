...
def parse_passes(competition):
    ...
    return pass_x_leading,pass_x_trailing,pass_count_leading,pass_count_trailing, pass_dist_leading,pass_dist_trailing
...
def run_analysis(competitions, mode):
    ...
    for competition in competitions:
        temp_x_l,temp_x_t,temp_count_l,temp_count_t,temp_dist_l,temp_dist_t=parse_passes(competition)
